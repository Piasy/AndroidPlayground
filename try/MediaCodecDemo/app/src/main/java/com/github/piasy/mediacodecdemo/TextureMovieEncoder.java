...
public class TextureMovieEncoder implements Runnable {
    ...
    private float[] mTextureFrameTransform = new float[16];
    ...
    private void logTransform(final float[] transform) {
        if (VERBOSE) {
            String log = "handleFrameAvailable " + this + "\ntr=\n";
            final int size = transform.length;
