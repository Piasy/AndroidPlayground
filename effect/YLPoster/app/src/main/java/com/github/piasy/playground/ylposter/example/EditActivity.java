...
public class EditActivity extends AppCompatActivity implements ChangeBgListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MainActivity.sIsSnow) {
            setContentView(R.layout.activity_edit_snow);
        } else {
            setContentView(R.layout.activity_edit_adhere);
        }
        ButterKnife.bind(this);

        mPoster.setChangeBgListener(this);
